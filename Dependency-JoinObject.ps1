...
#####################
# Joins objects just like SQL
# SEE:  https://blogs.msdn.microsoft.com/powershell/2012/07/13/join-object/

# TAGS Join,Object,SQL,Inner Join,Inner,Out Join,Outer,Combine,Columns
